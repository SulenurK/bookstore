 <div style="background-color: #5D4037" class="footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            ...
                                            <p class="beyazyazi">Hesaplı alışverişin keyfini çıkarın.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            <h2 class="beyazyazi">Tek Tıkla Güvenli Ödeme</h2>
                                            <p class="beyazyazi">Ödeme ve adres bilgilerinizi kaydedin, güvenli alışveriş yapın.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 pb-xs-30">
                                    <div class="li-shipping-inner-box">
                                        ...
                                        <div class="shipping-text">
                                            <h2 class="beyazyazi">7/24 Destek</h2>
                                            <p class="beyazyazi">Telefon ve mail ile dilediğiniz zaman bize ulaşın.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Li's Shipping Inner Box Area End Here -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="footer-logo">
                                        <img src="admin/resimler/logo/<?php echo $ayaral['logo'] ?>" alt="Footer Logo">
                                        <p class="beyazyazi">
                                            <?php echo $hakkimizdaal['hakkimizda_detay'] ?>
                                        </p>
                                    </div>
                                    <ul class="des">
                                        <li class="beyazyazi">
                                            <span>Adres: </span>
                                            <?php echo $ayaral['adres'] ?>
                                        </li>
                                        <li class="beyazyazi">
                                            <span>Telefon: </span>
                                            <?php echo $ayaral['telefon'] ?>
                                        </li>
                                        <li class="beyazyazi">
                                            <span>Email: </span>
                                           <?php echo $ayaral['email'] ?>
                                        </li>
                                    </ul>
                                </div>
...
<?php $kategori=$baglanti->prepare("SELECT * FROM  kategori where kategori_durum=:kategori_durum limit 6");
 ...
 ?>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="footer-newsletter">
                                        <h4 class="beyazyazi">Bültene Abone Olun</h4>
                                        <form action="islem" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="footer-subscribe-form validate" target="_blank" novalidate>
                                           <div id="mc_embed_signup_scroll">
                                              <div id="mc-form" class="mc-form subscribe-form form-group" >
                                                <input class="beyazyazi" id="mc-email" type="email" name="abone" placeholder="Email adresinizi giriniz" />
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="copyright text-center pt-25">
                                    <span><a target="_blank" href="https://www.bookstore.com">BookStore</a></span>
                                </div>
