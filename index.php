<?php require_once 'header.php' ?>
 ...
 <?php 
$urun=$baglanti->prepare("SELECT * FROM  urun  order by urun_id DESC");
$urun->execute();
 ...
 ?>
                                        ...
                                        <div class="single-product-wrap">
                                            <div class="product-image">
                                                <a href="urun-detay-<?=seolink($urunal['urun_baslik']).'-'.$urunal['urun_id'] ?>">
                                                    <img style="height: 200px" src="admin/resimler/urun/<?php echo $urunal['urun_resim'] ?>" alt="Li's Product Image">
                                                </a>
                        ...
                        <div id="li-bestseller-product" class="tab-pane" role="tabpanel">
                            <div class="row">
                                ...
                                <?php 
$urun=$baglanti->prepare("SELECT * FROM  urun where onecikan=:onecikan");
$urun->execute(array(
'onecikan'=>1
));
 while ($urunal=$urun->fetch(PDO::FETCH_ASSOC)) { 
 ...
 ?>
                        ...
                        <div id="li-featured-product" class="tab-pane" role="tabpanel">
                            <div class="row">
                                ...
                                <?php 
$urun=$baglanti->prepare("SELECT * FROM  urun order by urun_fiyat ASC");
$urun->execute();
 while ($urunal=$urun->fetch(PDO::FETCH_ASSOC)) { 
